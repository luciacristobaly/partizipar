...
return [
    ...
    */
    'cas_hostname' => env('CAS_HOSTNAME', 'loginnip.unizar.es'),
    ...
    */
    'cas_real_hosts' => env('CAS_REAL_HOSTS', 'loginnip.unizar.es'),
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    'cas_logout_url' => env('CAS_LOGOUT_URL', 'loginnip.unizar.es/cas/logout'),
    ...
    */
    'cas_redirect_path' => env('CAS_REDIRECT_PATH', 'https://127.0.0.1:8000/es'),
